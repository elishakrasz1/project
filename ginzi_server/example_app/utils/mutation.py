...
class SQLAlchemyMutation(graphene.Mutation):
        ...
        **options
        ...
        if arguments is None and not hasattr(cls, "Arguments"):
            ...
            if meta.delete == False:
                ...
                _out_name = "Delete"
        cls.output = graphene.Field(lambda: SQLAlchemyObjectTypes().get(model), description="description")
        cls.ok = graphene.Boolean(description="correct")
        cls.message = graphene.String(description="message")
    ...
    def mutate(cls, self, info, **kwargs):
        ...
        if meta.create == True:
            ...
            if not model:
                return cls(output=None, ok=False, message="message")
        if meta.delete == True:
        ...
        return cls(output=model, ok=True, message="message")
